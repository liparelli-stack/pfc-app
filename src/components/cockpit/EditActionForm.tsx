...
/* --------------------- Reconstrução (edição) --------------------- */
function reconstructSelectionId(params?: {
  kind?: string | null;
  direction?: Dir;
...
/* --------------------- Helpers de cor para chips de tag --------------------- */
const COLOR_PRESETS = [
  "#4C1D95",
  "#6D28D9",
  "#34B4BA",
...
const TagChip: React.FC<TagChipProps> = ({ slug, tag, onRemove }) => {
...
const EditActionForm: React.FC<EditActionFormProps> = ({
  ...
  // Mapeia selectionId ("task:null:orcamento") para label para o prompt
  const resolveActionLabel = (selectionId: string | undefined | null): string => {
